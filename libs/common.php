<?php
	...
	*/
	...
	/**
	* getArray: Devuelve el valor del index del array o en su defecto el valor que quiera el usuario si no
	existe
	*
	* @param $arr
	* @param $index
	...
	*/
	...
	/**
	* redirectTo: Redirecciona al cliente a la url indicada
	*
	* @param $url
	*/
